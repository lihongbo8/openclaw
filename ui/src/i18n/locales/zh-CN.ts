...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    aics: "查看已调度岗位任务、执行状态、阻塞原因和产物回写。",
    marketplace: "浏览可用岗位。",
    agents: "工作区、工具、身份。",
    activity: "浏览器本地工具活动摘要。",
    overview: "状态、入口点、健康。",
    workboard: "任务中心，集中查看岗位队列、执行状态、确认点与授权同步。",
    channels: "频道和设置。",
    instances: "已连接客户端和节点。",
    sessions: "活动会话和默认设置。",
    usage: "对话、岗位任务和费用记录。",
    cron: "唤醒和重复运行。",
    skills: "工具权限、Skill、API 绑定与云端能力管控。",
    skillWorkshop: "在提案成为上线技能之前，进行审查、优化并应用。",
    nodes: "配对设备和命令。",
    chat: "用自然语言安排任务。",
    goals: "管理年、季、月、周的经营目标和复盘节奏。",
    company: "管理部门、人员经营和目标责任。",
    projects: "查看承接经营目标的多个项目。",
  ...
  overview: {
    ...
    auth: {
      required: "本机连接需要验证。输入连接码或密码，然后点击连接。",
      failed: "验证失败。请使用 {command} 重新获取带连接码的 URL，或更新密码后再连接。",
    },
    pairing: {
      hint: "此设备需要网关主机的配对批准。",
      ...
      mobileHint: "在手机上？请从本机重新打开带连接码的页面。",
      docsTitle: "高级诊断文档（在新标签页中打开）",
      docsLink: "高级诊断",
    },
    insecure: {
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        title: "需要认证",
        summary: "本机服务可以访问，但连接前需要匹配的连接码或密码。",
        stepPaste: "粘贴本机提供的连接码，或输入已配置的密码。",
        stepGenerate: "如果没有连接码，请在本机重新生成。",
        stepConnect: "更新后再次点击连接。",
      },
      authFailed: {
        title: "认证不匹配",
        summary: "连接码或密码被拒绝。最常见原因是连接码已过期。",
        stepDashboard: "重新打开本机提供的新页面，或粘贴新的连接码。",
        stepReplace: "替换过期的连接码或密码。",
        stepMode: "一次只使用一种验证方式：连接码或密码。",
      },
      rateLimited: {
        title: "失败尝试过多",
        summary: "本机服务正在临时限制此客户端的认证尝试。",
      ...
      pairing: {
        ...
        summary: "此浏览器需要本机一次性批准后才能使用。",
        upgradeSummary: "此浏览器已知，但请求的访问权限已变更，需要重新批准。",
        stepList: "在本机查看待批准设备。",
        stepApproveId: "批准此请求：{requestId}。",
        stepApprove: "批准待处理的浏览器或设备请求。",
        stepReconnect: "批准完成后重新连接。",
      },
      insecure: {
        title: "需要安全浏览器上下文",
        summary: "此页面通过普通 HTTP 运行，因此浏览器无法创建预期的设备身份。",
        stepHttps: "请在本机打开安全连接页面。",
        stepLocalCompat: "如需本地兼容模式，请到设置的高级诊断中处理。",
        stepAvoidDisable: "避免为远程 HTTP 访问禁用设备认证。",
      },
      origin: {
        title: "浏览器来源不被允许",
        summary: "本机服务拒绝了此页面来源。",
        stepAllowedOrigins: "将此浏览器来源加入允许列表。",
        stepFullOrigin: "使用完整来源，例如 http://localhost:5173。",
        stepRestart: "更改允许来源后重启或重新加载本机服务。",
      },
      protocol: {
        title: "协议不匹配",
        summary: "当前页面与本机服务版本不一致。",
        stepDashboard: "重新打开本机提供的页面。",
        stepDevUi: "请重新构建或重启本地 UI。",
        stepRestart: "更新后重启本机服务。",
      },
      network: {
        title: "无法连接",
        summary: "浏览器无法完成本机连接。",
        stepGateway: "确认本机服务正在运行。",
        stepUrl: "检查连接地址。",
        stepDashboard: "重新打开本机提供的页面。",
      },
    },
