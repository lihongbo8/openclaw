...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "aics.apiConnections.readModel.get", scope: "operator.read" },
  { name: "aics.apiConnections.entry.create", scope: "operator.write" },
  { name: "aics.apiConnections.entry.update", scope: "operator.write" },
  { name: "aics.apiConnections.entry.delete", scope: "operator.write" },
  { name: "aics.apiConnections.entry.bindConfigPath", scope: "operator.write" },
  { name: "aics.apiConnections.entry.materialize", scope: "operator.write" },
  { name: "aics.apiConnections.entry.syncCloudVariables", scope: "operator.write" },
  { name: "aics.apiConnections.entry.test", scope: "operator.write" },
  { name: "aics.apiConnections.riskReport.get", scope: "operator.read" },
  { name: "aics.apiConnections.modelUsage.record", scope: "operator.write" },
  { name: "aics.toolSupply.categories.sync", scope: "operator.write" },
  { name: "aics.toolSupply.category.create", scope: "operator.write" },
  { name: "aics.toolSupply.readModel.get", scope: "operator.read" },
  { name: "aics.toolSupply.grant.set", scope: "operator.write" },
  { name: "aics.toolSupply.skill.setEnabled", scope: "operator.write" },
  { name: "aics.toolSupply.skill.uninstall", scope: "operator.write" },
  { name: "aics.toolSupply.plugin.setEnabled", scope: "operator.write" },
  { name: "aics.toolSupply.plugin.uninstall", scope: "operator.write" },
  { name: "aics.toolSupply.uniqueCapabilityRequest.prepare", scope: "operator.write" },
  { name: "aics.toolSupply.binding.set", scope: "operator.write" },
  { name: "aics.toolSupply.binding.remove", scope: "operator.write" },
  { name: "aics.toolSupply.binding.sync", scope: "operator.write" },
  { name: "aics.toolSupply.categoryCapability.activateReadyPackage", scope: "operator.write" },
  { name: "aics.toolSkillDevelopment.status.get", scope: "operator.read" },
  { name: "aics.toolSkillDevelopment.prepareReview", scope: "operator.write" },
  { name: "aics.toolSkillDevelopment.source.plan", scope: "operator.write" },
  { name: "aics.toolSkillDevelopment.source.select", scope: "operator.write" },
  { name: "aics.toolSkillDevelopment.runtime.markReady", scope: "operator.write" },
  { name: "aics.toolSkillDevelopment.runValidation", scope: "operator.write" },
  { name: "aics.cloudMarketplace.auditQueue.get", scope: "operator.read" },
  { name: "aics.cloudMarketplace.capabilities.get", scope: "operator.read" },
  { name: "aics.cloudMarketplace.uniqueCapabilityRequests.get", scope: "operator.read" },
  { name: "aics.cloudMarketplace.businessSummary.get", scope: "operator.read" },
  { name: "aics.cloudMarketplace.dispatcherRoleReadModel.get", scope: "operator.read" },
  { name: "aics.cloudMarketplace.dispatcherRoleSelection.create", scope: "operator.write" },
  { name: "aics.cloudMarketplace.apiHealth.get", scope: "operator.read" },
  { name: "aics.cloudMarketplace.roleReview.approve", scope: "operator.write" },
  { name: "aics.closedLoop.readiness.get", scope: "operator.read" },
  { name: "aics.mainFlow.readModel.get", scope: "operator.read" },
  { name: "aics.mainFlow.operationsModel.run", scope: "operator.write" },
  { name: "aics.mainFlow.interaction.create", scope: "operator.write" },
  { name: "aics.mainFlow.observation.prepare", scope: "operator.write" },
  { name: "aics.mainFlow.observation.collect", scope: "operator.write" },
  { name: "aics.observation.toolPlan.run", scope: "operator.write" },
  { name: "aics.mainFlow.observation.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.observation.reject", scope: "operator.write" },
  { name: "aics.mainFlow.observation.markDataMissing", scope: "operator.write" },
  { name: "aics.mainFlow.attribution.prepare", scope: "operator.write" },
  { name: "aics.mainFlow.attribution.generateFromLatest", scope: "operator.write" },
  { name: "aics.mainFlow.attribution.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.attribution.reject", scope: "operator.write" },
  { name: "aics.mainFlow.attribution.requestMoreData", scope: "operator.write" },
  { name: "aics.mainFlow.goal.candidate.create", scope: "operator.write" },
  { name: "aics.mainFlow.goal.generateFromLatest", scope: "operator.write" },
  { name: "aics.mainFlow.goal.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.planning.prepare", scope: "operator.write" },
  { name: "aics.mainFlow.planning.generateFromLatest", scope: "operator.write" },
  { name: "aics.mainFlow.planning.regenerate", scope: "operator.write" },
  { name: "aics.mainFlow.planning.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.planning.item.update", scope: "operator.write" },
  { name: "aics.mainFlow.planning.item.cancel", scope: "operator.write" },
  { name: "aics.mainFlow.dispatch.proposal.create", scope: "operator.write" },
  { name: "aics.mainFlow.dispatch.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.dispatch.materializeTaskPackage", scope: "operator.write" },
  { name: "aics.mainFlow.dispatch.checkAndCreateQueue", scope: "operator.write" },
  { name: "aics.mainFlow.execution.preflight.get", scope: "operator.read" },
  { name: "aics.mainFlow.execution.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.execution.cost.confirm", scope: "operator.write" },
  { name: "aics.mainFlow.dispatch.runApprovedTask", scope: "operator.write" },
  { name: "aics.mainFlow.execution.confirmAndRun", scope: "operator.write" },
  { name: "aics.mainFlow.auto.generatePipeline", scope: "operator.write" },
  { name: "aics.buildSession.create", scope: "operator.write" },
  { name: "aics.buildSession.load", scope: "operator.read" },
  { name: "aics.buildSession.list", scope: "operator.read" },
  { name: "aics.buildSession.startBriefing", scope: "operator.write" },
  { name: "aics.buildSession.submitBrief", scope: "operator.write" },
  { name: "aics.buildSession.confirm", scope: "operator.write" },
  { name: "aics.buildSession.generate", scope: "operator.write" },
  { name: "aics.buildSession.progress", scope: "operator.read" },
  { name: "aics.buildSession.repair", scope: "operator.write" },
  { name: "aics.buildSession.cancel", scope: "operator.write" },
  { name: "aics.roleDevelopment.status.get", scope: "operator.read" },
  { name: "aics.roleDevelopment.prepareMissingCapability", scope: "operator.write" },
  { name: "aics.roleDevelopment.reduceScopeToBasic", scope: "operator.write" },
  { name: "aics.roleDeveloper.submitForListing", scope: "operator.write" },
  { name: "aics.supportContact.get", scope: "operator.read" },
  { name: "aics.roleCapabilityAnalysis.create", scope: "operator.write" },
  { name: "aics.categoryCapabilityRequest.create", scope: "operator.write" },
  { name: "aics.categoryCapabilityReview.list", scope: "operator.read" },
  { name: "aics.categoryCapabilityReview.get", scope: "operator.read" },
  { name: "aics.categoryCapabilityReview.events", scope: "operator.read" },
  { name: "aics.categoryCapabilityReview.approve", scope: "operator.write" },
  { name: "aics.categoryCapabilityReview.requestChanges", scope: "operator.write" },
  { name: "aics.categoryCapabilityReview.reject", scope: "operator.write" },
  { name: "aics.categoryCapabilityReview.syncToCloud", scope: "operator.write" },
  { name: "aics.categoryCapabilityReview.activateLocal", scope: "operator.write" },
  { name: "aics.rolePreListingReview.list", scope: "operator.read" },
  { name: "aics.rolePreListingReview.get", scope: "operator.read" },
  { name: "aics.rolePreListingReview.events", scope: "operator.read" },
  { name: "aics.rolePreListingReview.runValidation", scope: "operator.write" },
  { name: "aics.rolePreListingReview.bindCategory", scope: "operator.write" },
  { name: "aics.rolePreListingReview.requestChanges", scope: "operator.write" },
  { name: "aics.rolePreListingReview.reject", scope: "operator.write" },
  { name: "aics.rolePreListingReview.approve", scope: "operator.write" },
  { name: "aics.toolSkillReview.list", scope: "operator.read" },
  { name: "aics.toolSkillReview.get", scope: "operator.read" },
  { name: "aics.toolSkillReview.events", scope: "operator.read" },
  { name: "aics.toolSkillReview.runValidation", scope: "operator.write" },
  { name: "aics.toolSkillReview.requestChanges", scope: "operator.write" },
  { name: "aics.toolSkillReview.reject", scope: "operator.write" },
  { name: "aics.toolSkillReview.approve", scope: "operator.write" },
  { name: "aics.roles.mine.readModel.get", scope: "operator.read" },
  { name: "aics.roles.instanceStore.repair", scope: "operator.write" },
  { name: "dijie.marketplace.roles.list", scope: "operator.read" },
  { name: "dijie.roleAuthorization.create", scope: "operator.write" },
  { name: "aics.memory.candidates.list", scope: "operator.read" },
  { name: "aics.memory.candidates.confirm", scope: "operator.write" },
  { name: "aics.memory.candidates.reject", scope: "operator.write" },
  { name: "aics.memory.formal.search", scope: "operator.read" },
  { name: "dijie.roleTask.run", scope: "operator.write" },
  { name: "aics.executionConsole.readModel.get", scope: "operator.read" },
  { name: "aics.executionEvidence.readback.get", scope: "operator.read" },
  { name: "aics.execution.artifact.get", scope: "operator.read" },
  { name: "aics.execution.run", scope: "operator.write" },
  { name: "aics.execution.result.record", scope: "operator.write" },
