...
const loadAicsRolePreListingReviewHandlers = lazyHandlerModule(
  () => import("./server-methods/aics-role-pre-listing-review.js"),
  (module) => module.aicsRolePreListingReviewHandlers,
);
...
export const coreGatewayHandlers: GatewayRequestHandlers = {
  ...
  ...createLazyCoreHandlers({
    methods: [
      "aics.toolSupply.categories.sync",
      "aics.toolSupply.category.create",
      "aics.toolSupply.readModel.get",
      "aics.toolSupply.grant.set",
      "aics.toolSupply.skill.setEnabled",
      "aics.toolSupply.skill.uninstall",
      "aics.toolSupply.plugin.setEnabled",
      "aics.toolSupply.plugin.uninstall",
      "aics.toolSupply.uniqueCapabilityRequest.prepare",
      "aics.toolSupply.binding.set",
      "aics.toolSupply.binding.remove",
      "aics.toolSupply.binding.sync",
      "aics.toolSupply.categoryCapability.activateReadyPackage",
      "aics.toolSkillDevelopment.status.get",
      "aics.toolSkillDevelopment.prepareReview",
      "aics.toolSkillDevelopment.source.plan",
      "aics.toolSkillDevelopment.source.select",
      "aics.toolSkillDevelopment.runtime.markReady",
  ...
  ...createLazyCoreHandlers({
    methods: [
      ...
      "aics.cloudMarketplace.roleReview.approve",
      "aics.closedLoop.readiness.get",
      "aics.mainFlow.readModel.get",
      "aics.mainFlow.operationsModel.run",
      "aics.mainFlow.interaction.create",
      "aics.mainFlow.observation.prepare",
      "aics.mainFlow.observation.collect",
      "aics.observation.toolPlan.run",
      "aics.mainFlow.observation.confirm",
      "aics.mainFlow.observation.reject",
      "aics.mainFlow.observation.markDataMissing",
      "aics.mainFlow.attribution.prepare",
      "aics.mainFlow.attribution.generateFromLatest",
      "aics.mainFlow.attribution.confirm",
      "aics.mainFlow.attribution.reject",
      "aics.mainFlow.attribution.requestMoreData",
      "aics.mainFlow.goal.candidate.create",
      "aics.mainFlow.goal.generateFromLatest",
      "aics.mainFlow.goal.confirm",
      "aics.mainFlow.planning.prepare",
      "aics.mainFlow.planning.generateFromLatest",
      ...
      "aics.mainFlow.execution.preflight.get",
      "aics.mainFlow.execution.confirm",
  ...
  ...createLazyCoreHandlers({
    methods: [
      ...
      "aics.roleDevelopment.status.get",
  ...
  ...createLazyCoreHandlers({
    methods: [
      ...
      "aics.categoryCapabilityRequest.create",
      "aics.categoryCapabilityReview.list",
      "aics.categoryCapabilityReview.get",
      "aics.categoryCapabilityReview.events",
      "aics.categoryCapabilityReview.approve",
      "aics.categoryCapabilityReview.requestChanges",
      "aics.categoryCapabilityReview.reject",
      "aics.categoryCapabilityReview.syncToCloud",
      ...
      "aics.rolePreListingReview.bindCategory",
      "aics.rolePreListingReview.requestChanges",
      "aics.rolePreListingReview.reject",
      "aics.rolePreListingReview.approve",
      "aics.toolSkillReview.list",
      "aics.toolSkillReview.get",
      "aics.toolSkillReview.events",
      "aics.toolSkillReview.runValidation",
      "aics.toolSkillReview.requestChanges",
      "aics.toolSkillReview.reject",
      "aics.toolSkillReview.approve",
    ],
    loadHandlers: loadAicsRolePreListingReviewHandlers,
  }),
  ...createLazyCoreHandlers({
    methods: [
