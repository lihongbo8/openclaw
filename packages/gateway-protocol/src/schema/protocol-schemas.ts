...
export const ProtocolSchemas = {
  ...
  DijieOneTimeAuthorizationPricing: DijieOneTimeAuthorizationPricingSchema,
  DijieRoleTokenPricing: DijieRoleTokenPricingSchema,
  DijieModelProxyUsage: DijieModelProxyUsageSchema,
  DijieDeviceBindRequest: DijieDeviceBindRequestSchema,
  DijieDeviceBindResult: DijieDeviceBindResultSchema,
  DijieExecutionTokenRequest: DijieExecutionTokenRequestSchema,
  DijieExecutionGrant: DijieExecutionGrantSchema,
  DijieExecutionTokenResult: DijieExecutionTokenResultSchema,
  DijieRolePackageManifest: DijieRolePackageManifestSchema,
  DijieRoleResult: DijieRoleResultSchema,
  DijieRoleFeedbackPacket: DijieRoleFeedbackPacketSchema,
  DijieSchedulerState: DijieSchedulerStateSchema,
  DijieRoleCapabilityProfile: DijieRoleCapabilityProfileSchema,
  DijieMemoryCandidate: DijieMemoryCandidateSchema,
  DijieEvolutionCandidate: DijieEvolutionCandidateSchema,
  DijieAuditSummary: DijieAuditSummarySchema,
